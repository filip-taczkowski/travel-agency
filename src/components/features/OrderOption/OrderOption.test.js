...
describe('Component OrderOption', () => {
  it('should render w/o crashing', () => {
    const component = shallow(<OrderOption type='date' name='asd' />);
  ...
  it('should render title from prop name', () => {
    const expectedTitle = 'Title';
    const component = shallow(<OrderOption type='date' name={expectedTitle} />);
    ...
    switch (type) {
      ...
      case 'icons': {
        it('should render icon', () => {
          ...
          const noneIcon = renderedSubcomponent.find('Icon[name="times-circle"]');
          expect(noneIcon.length).toBe(1);
        });
      ...
      case 'checkboxes': {
        ...
        it('should change checkbox status on click', () => {
          const checkbox = renderedSubcomponent.find('input').at(1).simulate('change', { currentTarget: {checked: true}});
          expect(checkbox.prop('value')).toEqual(testValue);
          expect(mockSetOrderOption).toBeCalledTimes(1);
